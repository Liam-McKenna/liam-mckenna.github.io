...
export default function Experience() {
  ...
  const jobs = [
    ...
    },
    {
      ...
      time: "(1yr 8mos) Jun 2018 -> Jan 2020",
      description:
    ...
    },
    {
      ...
      time: "(5yrs 4mos) May 2012 - Aug 2017",
      description:
